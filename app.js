(function(){
  ...
  function saveGeoAnchor() {
    try { localStorage.setItem(GEO_ANCHOR_KEY, JSON.stringify({ anchorLat: _geo.anchorLat, anchorLng: _geo.anchorLng, anchorTime: _geo.anchorTime, promptedDate: _geo.prompted ? dateKey(new Date()) : '' })); } catch(e) {}
  }
  function loadGeoAnchor() {
    try {
      ...
      if (s && s.anchorLat) {
        ...
        // prompted seulement si c'est le même jour — le lendemain on re-détecte
